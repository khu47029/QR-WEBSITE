...
export const metadata = {
  title: "QR Content Gateway — Dynamic QR Code File & Document Sharing Platform",
  description:
  ...
  openGraph: {
    title: "QR Content Gateway — Any Content Behind One Dynamic QR",
    description:
      ...
      <footer className="border-t border-slate-900 bg-slate-950 px-6 py-10 text-center text-xs text-slate-500">
        <div className="mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-slate-400">QR Content Gateway</span>
          </div>
