...
export const metadata = constructMetadata({
  path: "/",
  title: "Dynamic QR Code File & Document Sharing Platform",
  description:
...
export default function LandingPage() {
  const platformSchema = buildPlatformGraph();
  const faqSchema = buildFaqSchema(faqs);

  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 overflow-x-hidden selection:bg-cyan-500/20 selection:text-cyan-200 flex flex-col justify-between">
      {/* Inject Structured Data (JSON-LD) for SEO */}
      <JsonLd schema={[platformSchema, faqSchema]} />
